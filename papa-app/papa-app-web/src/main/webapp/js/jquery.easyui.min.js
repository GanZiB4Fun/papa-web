...
_b92(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_ba7){
...
return $(_bab_).datebox("options").cleanText;  
},handler : function(_bac_) {//自定义添加清除按钮
$(_bac_).combo('setValue', '').combo('setText', '');
}}],formatter:function(date){
